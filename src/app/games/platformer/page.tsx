...
export default function PlatformerPage() {
  ...
  return (
    <main className="min-h-screen flex flex-col items-center justify-center p-4 space-y-8">
      ...
      <div
        id="game-container"
        className="w-full max-w-[1600px] aspect-[5/3] bg-gradient-to-b from-indigo-900 to-purple-900 rounded-2xl overflow-hidden shadow-2xl border border-purple-300/20"
      >
